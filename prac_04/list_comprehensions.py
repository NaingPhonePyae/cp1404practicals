...
# Completed list comprehension to create a list of all the full_names in lowercase format
lowercase_full_names = [name.lower() for name in full_names]
print(lowercase_full_names)

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# Completed list comprehension to create a list of integers from the above list of strings
bigger_numbers = [int(number) for number in almost_numbers]
print(bigger_numbers)

# Completed list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
print([number for number in bigger_numbers if number > 9])

# Completed (more advanced) use a list comprehension and the join string method
...
full_names = ", ".join(name.split(" ")[-1] for name in full_names if len(name) > 11)
print(full_names)
